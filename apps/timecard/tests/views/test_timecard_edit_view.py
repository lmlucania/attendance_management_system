...
class TestTimeCardEditView(BaseTestCase):
    ...
    def test_create_success(self):
        post_data = {
            ...
            'form-0-stamped_time_0': '2023-01-03', 'form-0-stamped_time_1': '07:00', 'form-0-kind': TimeCard.Kind.IN,
            'form-1-stamped_time_0': '2023-01-03', 'form-1-stamped_time_1': '19:00', 'form-1-kind': TimeCard.Kind.OUT}
    ...
    def test_create_failure_by_validation(self):
        post_data = {
            'form-TOTAL_FORMS': '4', 'form-INITIAL_FORMS': '2', 'form-MIN_NUM_FORMS': '0', 'form-MAX_NUM_FORMS': '4',
            'form-0-stamped_time_0': '2023-01-03', 'form-0-stamped_time_1': '17:00', 'form-0-kind': TimeCard.Kind.IN,
            'form-1-stamped_time_0': '2023-01-03', 'form-1-stamped_time_1': '07:00', 'form-1-kind': TimeCard.Kind.OUT}
    ...
    def test_delete(self):
        post_data = {
            ...
            'form-0-id': 1, 'form-0-stamped_time_0': '2023-01-02', 'form-0-stamped_time_1': '07:00',
            'form-0-kind': TimeCard.Kind.IN, 'form-0-DELETE': 'on',
            'form-1-id': 2, 'form-1-stamped_time_0': '2023-01-02', 'form-1-stamped_time_1': '19:00',
            'form-1-kind': TimeCard.Kind.OUT, 'form-1-DELETE': 'on',
            'form-2-id': 3, 'form-2-stamped_time_0': '2023-01-02', 'form-2-stamped_time_1': '07:00',
            'form-2-kind': TimeCard.Kind.ENTER_BREAK, 'form-2-DELETE': 'on',
            'form-3-id': 4, 'form-3-stamped_time_0': '2023-01-02', 'form-3-stamped_time_1': '07:00',
            'form-3-kind': TimeCard.Kind.END_BREAK, 'form-3-DELETE': 'on',
        }
    ...
    def test_update_success(self):
        post_data = {
            'form-TOTAL_FORMS': '4', 'form-INITIAL_FORMS': '4', 'form-MIN_NUM_FORMS': '0', 'form-MAX_NUM_FORMS': '4',
            'form-0-id': 1, 'form-0-stamped_time_0': '2023-01-04', 'form-0-stamped_time_1': '07:30',
            'form-0-kind': TimeCard.Kind.IN,
            'form-1-id': 2, 'form-1-stamped_time_0': '2023-01-04', 'form-1-stamped_time_1': '19:30',
            'form-1-kind': TimeCard.Kind.OUT,
            'form-2-id': 3, 'form-2-stamped_time_0': '2023-01-04', 'form-2-stamped_time_1': '12:30',
            'form-2-kind': TimeCard.Kind.ENTER_BREAK,
            'form-3-id': 4, 'form-3-stamped_time_0': '2023-01-04', 'form-3-stamped_time_1': '13:30',
    ...
    def test_update_failure_by_validation(self):
        post_data = {
            'form-TOTAL_FORMS': '4', 'form-INITIAL_FORMS': '4', 'form-MIN_NUM_FORMS': '0', 'form-MAX_NUM_FORMS': '4',
            'form-0-id': 1, 'form-0-stamped_time_0': '2023-01-04', 'form-0-stamped_time_1': '20:30',
            'form-0-kind': TimeCard.Kind.IN,
            'form-1-id': 2, 'form-1-stamped_time_0': '2023-01-04', 'form-1-stamped_time_1': '19:30',
            'form-1-kind': TimeCard.Kind.OUT,
            'form-2-id': 3, 'form-2-stamped_time_0': '2023-01-04', 'form-2-stamped_time_1': '12:30',
